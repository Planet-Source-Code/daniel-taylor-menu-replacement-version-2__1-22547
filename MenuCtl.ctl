...
Public Function AddItem(Caption As String, Optional Name As String = "", Optional Enabled As Boolean = True, Optional ItemIcon As StdPicture, Optional ItemForeColor As OLE_COLOR = -1, Optional ItemHotForeColor As OLE_COLOR = -1, Optional ItemHotBackColor As OLE_COLOR = -1) As Boolean
    ...
    If ItemForeColor = -1 Then
        Items(ItemCount).IForecolor = m_ItemForeColor
    Else
        Items(ItemCount).IForecolor = ItemForeColor
    End If
    If ItemHotForeColor = -1 Then
        Items(ItemCount).IHotForecolor = m_ItemHotForeColor
    Else
        Items(ItemCount).IHotForecolor = ItemHotForeColor
    End If
    If ItemHotBackColor = -1 Then
        Items(ItemCount).IHotBackcolor = m_ItemHotBackColor
    Else
        Items(ItemCount).IHotBackcolor = ItemHotBackColor
    End If
End Function

'ACHTUNG! DIE FOLGENDEN KOMMENTIERTEN ZEILEN NICHT ENTFERNEN ODER VERÄNDERN!
'MemberInfo=14
Public Sub ShowMenu(Optional X As Long = -1, Optional Y As Long = -1, Optional LeftImage As StdPicture)
    ...
    Set LeftPic = LeftImage
    MenuFrm.BackColor = m_BackColor
    MenuFrm.Width = 1
    MenuFrm.Height = 1
    ...
    Dim TempText As String, TempIndex As Integer, Raiseevents As Boolean, TempName As String
    ...
    If Raiseevents = True Then
        RaiseEvent ItemClicked(TempIndex, TempText, TempName)
    End If
End Sub
...
Private Sub UserControl_InitProperties()
    ...
    m_UseLeftImage = m_def_UseLeftImage
    m_LeftPicBackColor = m_def_LeftPicBackColor
    m_MouseOverSelectionType = m_def_MouseOverSelectionType
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    m_UseLeftImage = PropBag.ReadProperty("UseLeftImage", m_def_UseLeftImage)
    m_LeftPicBackColor = PropBag.ReadProperty("LeftPicBackColor", m_def_LeftPicBackColor)
    m_MouseOverSelectionType = PropBag.ReadProperty("MouseOverSelectionType", m_def_MouseOverSelectionType)
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("UseLeftImage", m_UseLeftImage, m_def_UseLeftImage)
    Call PropBag.WriteProperty("LeftPicBackColor", m_LeftPicBackColor, m_def_LeftPicBackColor)
    Call PropBag.WriteProperty("MouseOverSelectionType", m_MouseOverSelectionType, m_def_MouseOverSelectionType)
End Sub

'ACHTUNG! DIE FOLGENDEN KOMMENTIERTEN ZEILEN NICHT ENTFERNEN ODER VERÄNDERN!
'MemberInfo=14,0,0,0
Public Property Get Style() As Style_Type
    Style = m_Style
End Property

Public Property Let Style(ByVal New_Style As Style_Type)
    m_Style = New_Style
...
'ACHTUNG! DIE FOLGENDEN KOMMENTIERTEN ZEILEN NICHT ENTFERNEN ODER VERÄNDERN!
'MemberInfo=0,0,0,0
Public Property Get UseLeftImage() As Boolean
    UseLeftImage = m_UseLeftImage
End Property

Public Property Let UseLeftImage(ByVal New_UseLeftImage As Boolean)
    m_UseLeftImage = New_UseLeftImage
    PropertyChanged "UseLeftImage"
End Property

'ACHTUNG! DIE FOLGENDEN KOMMENTIERTEN ZEILEN NICHT ENTFERNEN ODER VERÄNDERN!
'MemberInfo=10,0,0,0
Public Property Get LeftPicBackColor() As OLE_COLOR
    LeftPicBackColor = m_LeftPicBackColor
End Property

Public Property Let LeftPicBackColor(ByVal New_LeftPicBackColor As OLE_COLOR)
    m_LeftPicBackColor = New_LeftPicBackColor
    PropertyChanged "LeftPicBackColor"
End Property

'ACHTUNG! DIE FOLGENDEN KOMMENTIERTEN ZEILEN NICHT ENTFERNEN ODER VERÄNDERN!
'MemberInfo=14,0,0,0
Public Property Get MouseOverSelectionType() As Sel_Type
    MouseOverSelectionType = m_MouseOverSelectionType
End Property

Public Property Let MouseOverSelectionType(ByVal New_MouseOverSelectionType As Sel_Type)
    m_MouseOverSelectionType = New_MouseOverSelectionType
    PropertyChanged "MouseOverSelectionType"
End Property
